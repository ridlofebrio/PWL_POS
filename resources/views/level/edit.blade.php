    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/level/'.$level->level_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                        <input type="text" class="form-control" id="level_id" name="level_id" value="{{ old('level_id', $level->level_id) }}" required>
                        @error('level_id')
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="text" class="form-control" id="level_name" name="level_name" value="{{ old('level_name', $level->nama) }}" required>
                    @error('level_name')
                    <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
